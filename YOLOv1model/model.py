...
class Yolov1(nn.Module):
    def __init__(self, in_channels=3, S=7, B=2, C=20): #default to 3 becasue rgb images
    ...
    def _create_conv_layers(self, architecture):
        ...
        return nn.Sequential(*layers) #*layers will unpack the list and convert it to nn.sequential
